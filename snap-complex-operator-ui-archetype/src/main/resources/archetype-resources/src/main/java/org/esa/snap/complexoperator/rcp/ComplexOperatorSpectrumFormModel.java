...
import org.esa.snap.complexoperator.common.SpectrumCsvIO;
...
class ComplexOperatorSpectrumFormModel {
    ...
    ComplexOperatorSpectrumFormModel(AppContext appContext, ComplexOperatorForm samForm) {
    ...
    ComplexOperatorSpectrumFormModel(AppContext appContext, Callable<Product> productAccessor) {
        this(appContext, (ComplexOperatorForm) null);
        ComplexOperatorSpectrumFormModel.productAccessor = productAccessor;
    }
    ...
    private class AddAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            dialog.show();
            dialog.getButton(ModelessDialog.ID_APPLY).addActionListener(evt -> {
                executeInput();
            });
        }
